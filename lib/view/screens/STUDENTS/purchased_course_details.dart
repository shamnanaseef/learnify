...
class PurchasedCourseDetails extends ConsumerStatefulWidget {
  final Course course;
  const PurchasedCourseDetails({super.key, required this.course});

  @override
  ConsumerState<PurchasedCourseDetails> createState() => _PurchasedCourseDetailsState();
}

class _PurchasedCourseDetailsState extends ConsumerState<PurchasedCourseDetails> {
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return ExpansionTile(
                            ...
                            children: section.videos.map((video) {
                              return ListTile(
                                leading: Icon(Icons.play_circle_fill, color: AppColors.buttonColor),
